...
def ensure_sqlite_phase0_columns() -> None:
    ...
    with engine.connect() as conn:
        ...
        alter_statements = [
            ...
            ("ats_score", "ALTER TABLE recruiter_emails ADD COLUMN ats_score FLOAT"),
            ("ats_score_source", "ALTER TABLE recruiter_emails ADD COLUMN ats_score_source VARCHAR(80)"),
            ("ats_summary", "ALTER TABLE recruiter_emails ADD COLUMN ats_summary TEXT"),
            ("ats_breakdown_json", "ALTER TABLE recruiter_emails ADD COLUMN ats_breakdown_json TEXT"),
            ("resume_picker_score", "ALTER TABLE recruiter_emails ADD COLUMN resume_picker_score FLOAT"),
            ("resume_picker_reason", "ALTER TABLE recruiter_emails ADD COLUMN resume_picker_reason TEXT"),
            ("resume_picker_candidates_json", "ALTER TABLE recruiter_emails ADD COLUMN resume_picker_candidates_json TEXT"),
            ("resume_picker_breakdown_json", "ALTER TABLE recruiter_emails ADD COLUMN resume_picker_breakdown_json TEXT"),
        ...
        settings_alter_statements = [
            ...
            ("nvoids_detail_title_mode", "ALTER TABLE user_settings ADD COLUMN nvoids_detail_title_mode VARCHAR(40) DEFAULT 'job_details'"),
