...
from app.services.provider_credential_service import ProviderCredentialsUnavailable
...
FAILURE_MESSAGES = {
    ...
    "ollama_credentials_missing": "Add your Ollama API key in Settings to use chat.",
...
def classify_ollama_error(exc: Exception) -> str:
    if isinstance(exc, ProviderCredentialsUnavailable):
        return "ollama_credentials_missing"
