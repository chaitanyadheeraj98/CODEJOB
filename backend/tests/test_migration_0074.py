...
def test_label_migration_round_trip(tmp_path, monkeypatch):
    ...
    # Pinned to this migration rather than "head": the assertions below are
    # about what 0074 does, and a later revision becoming head used to make
    # the downgrade at the end undo the wrong thing.
