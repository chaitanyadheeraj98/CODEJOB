"""Migration 0066: the manual-intake content fingerprint.
...
PREVIOUS_REVISION = "20260904_0065"
TABLE = "recruiter_emails"
COLUMN = "manual_dedupe_hash"
INDEX = "ix_recruiter_emails_manual_dedupe_hash"
...
class ManualDedupeHashMigrationTests(unittest.TestCase):
